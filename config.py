...
class Settings:
    default_mode: str = os.getenv("DEFAULT_MODE", "personal")

    llm_provider: str = os.getenv("AOB_LLM_PROVIDER", "mock")
    llm_base_url: str = os.getenv("OPENAI_COMPAT_BASE_URL", "https://api.openai.com/v1").rstrip("/")
    llm_api_key: str = os.getenv("OPENAI_COMPAT_API_KEY", "")
    llm_model: str = os.getenv("OPENAI_COMPAT_MODEL", "")
